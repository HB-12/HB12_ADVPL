...
static function reportDef()
	Local oReport
	Local oSection1
	Local cTitulo	:= "Relatorio Pedido de Compras "+Dtoc(dDataIni)+" a "+Dtoc(dDataFim)
...
Static Function FSeleDados()
	...
	***********************************************/
	...
	cQrySC7 += "WHERE 
	cQrySC7 += " SC7.C7_EMISSAO  >= '"+DTOS(dDataIni)+"' AND  SC7.C7_EMISSAO  <= '"+DTOS(dDataFim)+"' "+CRLF		
	cQrySC7 += " AND SC7.C7_FILIAL " + GetRngFil( aSelFil, "SC7", .T., @cTmpSE2Fil ) + "  "
